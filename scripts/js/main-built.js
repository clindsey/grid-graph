...
(function() {
  ...
  define('models/HeightmapChunk',["Backbone"], function() {
...
(function() {
  ...
  define('models/Heightmap',["models/HeightmapChunk", "models/MapTile", "Alea", "Backbone"], function(HeightmapChunkModel, MapTileModel) {
    var Heightmap;
    Heightmap = Backbone.Model.extend({
      ...
      processTiles: function(heightmap) {
        var a, b, c, cx, cy, d, data, e, f, g, h, mapTileModel, n, ne, nw, o, s, se, sw, w, x, xl, y, yl, _i, _j, _ref, _ref1,
          _this = this;
        data = [];
...
(function() {
  ...
  define('views/viewport/ViewportTile',["models/Heightmap", "Backbone"], function(heightmapModel) {
    var ViewportTile;
...
(function() {
  ...
  define('models/Viewport',["models/Heightmap", "collections/ViewportTiles", "Backbone"], function(heightmapModel, viewportTiles) {
    var Viewport;
...
(function() {
  ...
  define('models/Entity',["Backbone"], function() {
    var Entity;
...
(function() {
  ...
  define('models/Creature',["models/Entity", "models/Heightmap", "Machine", "Backbone"], function(EntityModel, heightmapModel) {
    var Creature;
...
(function() {
  ...
  define('collections/Creatures',["models/Creature", "Backbone"], function(CreatureModel) {
    var Creatures;
...
(function() {
  ...
  define('views/entities/Entity',["models/Viewport", "models/Heightmap", "Backbone"], function(viewportModel, heightmapModel) {
    var Entity;
...
(function() {
  ...
  define('views/viewport/Viewport',["collections/ViewportTiles", "views/viewport/ViewportTile", "models/Viewport", "models/Heightmap", "collections/Creatures", "models/Creature", "views/entities/Creature", "Backbone"], function(viewportTiles, ViewportTileView, viewportModel, heightmapModel, creatures, CreatureModel, CreatureView) {
    var ViewportView;
...
(function() {
  ...
  define('views/toolbar/Toolbar',["Backbone"], function() {
    var ToolbarView;
...
(function() {
  ...
  define('views/App',["views/viewport/Viewport", "models/Viewport", "views/toolbar/Toolbar", "Alea", "Backbone"], function(ViewportView, viewportModel, ToolbarView) {
    var AppView;
