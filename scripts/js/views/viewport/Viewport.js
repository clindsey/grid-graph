...
(function() {
  ...
  define(["collections/ViewportTiles", "views/viewport/ViewportTile", "models/Viewport", "models/Heightmap", "collections/Creatures", "models/Creature", "views/entities/Creature", "models/Foreman", "Backbone"], function(viewportTiles, ViewportTileView, viewportModel, heightmapModel, creatures, CreatureModel, CreatureView, foremanModel) {
    var ViewportView;
    return ViewportView = Backbone.View.extend({
      ...
      onMapTileClick: function(viewportTileView) {
        ...
        switch (this.options.toolbarView.activeContext) {
          ...
          case "home":
            this.putHome(tileModel);
            return foremanModel.findJob(tileModel.get("creature"));
          case "farm":
            this.putFarm(tileModel);
            return foremanModel.findWorker(tileModel);
          case "refinery":
